...
const TAKE_OPTIONS = Object.freeze({
  quality: 0.85,
  skipProcessing: true,
} as const);
...
const TopBar = memo(
  ({ loading, mission }: { loading: boolean; mission?: Mission | null }) => (
    ...
    >
      <View
        style={[
          ...
          disabled && styles.captureInnerDisabled,
        ]}
      />
    </TouchableOpacity>
  ),
...
const CameraScreen = () => {
  ...
  const [todayMission, setTodayMission] = useState<Mission | string>(
    "오늘의 미션",
  );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.overlay} pointerEvents="box-none">
        <TopBar
          loading={loading}
          mission={
            typeof todayMission === "string"
              ? undefined
              : (todayMission as Mission)
          }
        />
